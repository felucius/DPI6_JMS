...
public class BrokerMessageListener implements MessageListener {
    ...
    public void onMessage(Message msg) {
        try {
            ...
            System.out.println("Restaurant API 2: Restaurant received: " + request.getName()
    ...
    public void addReservationReply(ReservationReply reply) {
        try {
            ...
            String url = "http://localhost:46420/JMS_RestaurantAPI_2/api/reservationreplies";
            URL obj = new URL(url);
    ...
    public ReservationReply getReservationReply() {
        try {
            String url = "http://localhost:46420/JMS_RestaurantAPI_2/api/reservationreplies/reply";
            ...
            //print result
            System.out.println("Restaurant API 2: Answer: " + response.toString());
