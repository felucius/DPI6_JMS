...
public class init {
    ...
    @PostConstruct
    public void init() {
        Restaurant restaurant = new Restaurant("Tokyo Sushi and Wok", "Eindhoven", 30);
    ...
    public void connectToBroker() {
        MessageReceiverGateway brokerToRestaurantReceiver = new MessageReceiverGateway("FromBrokerToRestaurantAPI2");
